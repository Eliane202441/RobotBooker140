...
TC002     Eliane    Lima    ${totalprice}    ${depositpaid}    ${checkin}    ${checkout}    ${additionalneeds}
TC003      ${firstname}    ${lastname}    ${totalprice}    ${depositpaid}    ${checkin}    ${checkout}    ${additionalneeds}
*** Keywords ***
Create Booking DDT
